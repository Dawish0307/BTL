...
<head>
    ...
    <title>Đăng Nhập – Gia Lai Tourism</title>
    ...
    <div class="auth-left">
        <div class="auth-left-content">
            ...
            <div class="auth-hero-text">
                ...
                <p>Đăng nhập để lưu hành trình, chia sẻ trải nghiệm và khám phá những điểm đến tuyệt vời nhất của Gia Lai.</p>
            </div>
            <div class="auth-features">
                <div class="af-item"><span>🌊</span><span>Lưu địa điểm yêu thích</span></div>
                <div class="af-item"><span>⭐</span><span>Đánh giá & bình luận</span></div>
                <div class="af-item"><span>🗺</span><span>Lên kế hoạch du lịch</span></div>
            </div>
            <div class="auth-deco">
            ...
            <form id="loginForm" class="auth-form" novalidate>
                ...
                <div class="input-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <button type="button" class="toggle-pw" id="togglePw" aria-label="Hiện/ẩn mật khẩu">👁</button>
                    </div>
